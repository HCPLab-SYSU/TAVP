...
from .multitask_rlbench_env import RLBenchEnv, MultiTaskRLBenchEnv
...
class CustomMultiTaskRLBenchEnv2(CustomMultiTaskRLBenchEnv):
    ...
    def reset_to_demo_v1(self, i, variation_number=-1):
        if self._episodes_this_task == self._swap_task_every:
            self._set_new_task()
            self._episodes_this_task = 0
        self._episodes_this_task += 1
        ...
        # print(d)
        if d.variation_number == None:
            print("d.variation_number is None!")
            d.variation_number = 0
        self._task.set_variation(d.variation_number)
        # print("reset start ....")
        try:
        ...
        return True, self._previous_obs_dict
        # return 0
